(* OASIS_START *)
(* DO NOT EDIT (digest: 3f4c15483d5265f72dc0670c0111d0db) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("Cpachecker", ["deps/temper/main/thrift/cpachecker/gen-ocaml"], []);
          ("Ultimate", ["deps/temper/main/thrift/ultimate/gen-ocaml"], []);
          ("tcfa", ["deps/temper/main/src"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
       [
          ("src", ["deps/temper/main/src"]);
          ("deps/temper/main/src",
            [
               "deps/temper/main/thrift/cpachecker/gen-ocaml";
               "deps/temper/main/thrift/ultimate/gen-ocaml"
            ])
       ]
  }
  ;;
